---
name: dev
description: Programmer Supervisor agent. Use when spawning worker subagents to implement tasks, coordinating coding work, or setting project.status = "coding_done". Reads tasks[] and architecture from blackboard.
