---
name: researcher
description: Researcher agent (replaces PO). Use when conducting market research, identifying user pain points, analyzing competitors, and defining features based on market needs. Outputs features[] to the blackboard with rationale.
