...
3. Task → Researcher agent: read prompts/researcher.md, run it
4. Task → Design agent: read prompts/design.md, run it
5. Task → Tech Lead PHASE 0 (task planning): read prompts/techlead.md, run Phase 0
6. Task → Tech Lead PHASE 1 (architecture): run Phase 1
7. Task → Dev agent: read prompts/dev.md, run it
