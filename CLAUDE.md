...
This project is indexed by GitNexus as **software-team** (160 symbols, 150 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/software-team/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/software-team/context` | Codebase overview, check index freshness |
| `gitnexus://repo/software-team/clusters` | All functional areas |
| `gitnexus://repo/software-team/processes` | All execution flows |
| `gitnexus://repo/software-team/process/{name}` | Step-by-step execution trace |
